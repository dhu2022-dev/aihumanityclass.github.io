...
Sam Altman has suggested that systems capable of producing real, new insights could arrive as early as 2026 [TODO: source and link]. Dario Amodei makes a similar point, especially in biology, where he believes AI could help drive major breakthroughs by taking on larger parts of the research process, not just small tasks [TODO: source and link]. At a more practical level, tools like Andrew Ng and Yixing Jiang’s [Agentic Reviewer](TODO) already show how AI can help researchers move faster, with results that line up closely with human reviewers. Overall, the shift is clear: AI is no longer just helping with research—it is starting to change how research gets done.
